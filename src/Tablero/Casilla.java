...
public class Casilla {
	...
	/**
	 * Constructor de la clase Casilla, se usa cuando en la casilla no va ha tener
	 * definifa la ficha
	 * 
	...
	/**
	 * Constructor de la clase Casilla, se usa cuando la casilla va ha tener
	 * definida la ficha.
	 * 
	 * @param posicion1 Posicion vertical de la casilla.
	 * @param posicion2 Posicion horizontal de la casilla
	...
	/**
	 * Metodo que sobrescribe el metodo hascCode() de Object, que se encarga crea un
	 * hascode unico para la casilla.
	 */
	@Override
	public int hashCode() {
	...
	/**
	 * Metodo que sobre escribe un metodo de object, que se encarga en compara
	 * objetos.
	 */
	@Override

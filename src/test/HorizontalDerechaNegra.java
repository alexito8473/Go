...
class HorizontalDerechaNegra {
	...
	void horizontal_Vertical_Inclinado_Comer2_MedioTablero() {
		...
		rellenaInclinadaAbajo(new Coordenada(2,1),new Coordenada(6,5),tableroPrueba.getTablero(),Ficha.BLANCO);ponerFicha(tableroPrueba.getTablero()[2][1],Ficha.BLANCO);
	...
	void horizontalDerecha_VerticalArriba_InclinadoArribaDerecha_Comer3_MedioTablero() {
		...
		ponerFicha(tableroPrueba.getTablero()[2][5],Ficha.NEGRO);
		ponerFicha(tableroPrueba.getTablero()[6][5],Ficha.NEGRO);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 6,1);
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	...
	void horizontalIzquierda_VerticalArriba_InclinadoArribaIzquierda_Comer3_MedioTablero() {
		...
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 6,6);
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	...
	void horizontalIzquierda_VerticalAbajo_InclinadoAbajoIzquierda_Comer3_MedioTablero() {
		...
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 1,6);
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	...
	void horizontalDerecha_VerticalAbajo_InclinadoAbajoDerecha_Comer3_MedioTablero() {
		...
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 1,1);
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	...
	void horizontalDerecha_VerticalAbajo_InclinadoAbajoDerecha_Comer1_Borde() {
		...
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 0,0);
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	...
	void horizontalIzquierda_VerticalAbajo_InclinadoAbajoIzquierda_Comer1_Borde() {
		...
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 0,7);
	...
	void horizontalIzquierda_VerticalArriba_InclinadoArribaIzquierda_Comer1_Borde() {
		...
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 7,7);
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	@Test
	...
	void horizontalDerecho_VerticalArriba_InclinadoArribaDerecho_Comer1_Borde() {
		...
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 7,0);
	...
	void HorizontalNoValido() {
		...
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 1,1);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 2,1);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 3,1);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 5,5);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 6,6);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 7,6);
	...
	void verticalNoValido() {
		...
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 1,1);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 1,2);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 1,3);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 6,5);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 6,6);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 6,7);
	...
	void inclinada() {
		...
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 2,7);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 0,4);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 7,2);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 4,0);
		
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 2,0);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 0,3);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 7,5);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 4,7);
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	...
	void inclinada_AbajoDerecha_ArribaIzquierdaNV() {
		...
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 1,5);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 1,4);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 1,3);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 6,2);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 6,3);
		tableroPrueba.añadirFichaTablero(Ficha.NEGRO, 6,4);

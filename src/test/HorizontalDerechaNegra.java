...
class HorizontalDerechaNegra {
	...
	void horizontal_Vertical_Inclinado_Comer1_MedioTablero() {
		...
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(4, 3));
	...
	void horizontalDerecha_VerticalArriba_InclinadoArribaDerecha_Comer3_MedioTablero() {
		...
		ponerFicha(tableroPrueba.getTablero()[2][5], Ficha.NEGRO);
		ponerFicha(tableroPrueba.getTablero()[6][5], Ficha.NEGRO);
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(6, 1));
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	...
	void horizontalIzquierda_VerticalArriba_InclinadoArribaIzquierda_Comer3_MedioTablero() {
		...
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(6, 6));
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	...
	void horizontalIzquierda_VerticalAbajo_InclinadoAbajoIzquierda_Comer3_MedioTablero() {
		...
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(1, 6));
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	...
	void horizontalDerecha_VerticalAbajo_InclinadoAbajoDerecha_Comer3_MedioTablero() {
		...
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(1, 1));
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	...
	void horizontalDerecha_VerticalAbajo_InclinadoAbajoDerecha_Comer1_Borde() {
		...
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(0, 0));
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	...
	void horizontalIzquierda_VerticalAbajo_InclinadoAbajoIzquierda_Comer1_Borde() {
		...
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(0, 7));
	...
	void horizontalIzquierda_VerticalArriba_InclinadoArribaIzquierda_Comer1_Borde() {
		...
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(7, 7));
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	...
	void horizontalDerecho_VerticalArriba_InclinadoArribaDerecho_Comer1_Borde() {
		...
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(7, 0));
	...
	void HorizontalNoValido() {
		...
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(1, 1));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(2, 1));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(3, 1));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(5, 5));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(6, 6));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(7, 6));
	...
	void verticalNoValido() {
		...
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(1, 1));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(1, 2));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(1, 3));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(6, 5));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(6, 6));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(6, 7));
	...
	void inclinada() {
		...
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(2, 7));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(0, 4));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(7, 2));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(4, 0));

		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(2, 0));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(0, 3));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(7, 5));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(4, 7));
		Assert.assertArrayEquals(tableroDevolver, tableroPrueba.getTablero());
	}
	...
	void inclinada_AbajoDerecha_ArribaIzquierdaNV() {
		...
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(1, 5));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(1, 4));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(1, 3));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(6, 2));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(6, 3));
		tableroPrueba.anadirFichaTablero(Ficha.NEGRO, new Coordenada(6, 4));
